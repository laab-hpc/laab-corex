...
$LAAB_BUILD_DIR/gemm_rocblas.exe \
...
Legacy executable names `dgemm_rocblas.exe`, `sgemm_rocblas.exe`, and
`zgemm_rocblas.exe` are also produced for compatibility. They all dispatch by
matrix filename dtype.
