...
srun -N 1 -n 2 -c 1 --gpus-per-task=a100:1 --distribution=block:cyclic:cyclic --threads-per-core=1 "$LAAB_BUILD_DIR/pgemm.exe" -A $INPUTS_DIR/dense/M15000x15000-float64-gen.dense -B $INPUTS_DIR/dense/M15000x15000-float64-gen.dense -b 256 --reps 5 --tag "fp64"
